...
<template>
  ...
  >
    <span class="text-[11px] text-white/45 font-bold whitespace-nowrap">Selection</span>
    <span class="text-[12px] text-white font-extrabold font-heading tabular-nums">{{ formatTime(state.selection.start) }}</span>
    <div class="w-px h-3.5 bg-white/15"></div>
    <span class="text-[11px] text-white/45 font-bold">to</span>
    <span class="text-[12px] text-white font-extrabold font-heading tabular-nums">{{ formatTime(state.selection.end) }}</span>

    <div class="w-px h-3.5 bg-white/15"></div>

    <span class="text-[11px] text-white/45 font-bold whitespace-nowrap">Duration</span>
    <span class="text-[12px] text-white font-extrabold font-heading tabular-nums">{{ (state.selection.end - state.selection.start).toFixed(2) }}s</span>
