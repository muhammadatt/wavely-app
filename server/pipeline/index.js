...
function formatClipGainDeEsserResult(r) {
  ...
  return {
    ...
    max_reduction_db:              r.maxReductionDb,
    strident_ceiling_db:           r.stridentCeilingDb,
    non_strident_ceiling_db:       r.nonStridentCeilingDb,
...
function formatParallelCompressionResult(r) {
  ...
  return {
    ...
    parallel_desser_source:                r.parallelDesserSource,
    parallel_desser_skip_reason:           r.parallelDesserSkipReason,
    parallel_desser_event_count:           r.parallelDesserEventCount,
    parallel_desser_total_event_count:     r.parallelDesserTotalEventCount,
    parallel_desser_skipped_in_range:      r.parallelDesserSkippedInRange,
    parallel_desser_skipped_no_context:    r.parallelDesserSkippedNoContext,
    parallel_desser_treated_events:        r.parallelDesserTreatedEvents,
    parallel_desser_strident_ceiling_db:     r.parallelDesserStridentCeilingDb,
    parallel_desser_non_strident_ceiling_db: r.parallelDesserNonStridentCeilingDb,
    parallel_desser_reduction_ratio:       r.parallelDesserReductionRatio,
